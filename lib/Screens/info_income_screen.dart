...
//Screen: Doanh thu thông tin
class InfoIncomeScreen extends StatelessWidget {
  const InfoIncomeScreen({Key? key}) : super(key: key);

  //Tạo Route cho Navigation
  static const routeName = '/info-income';
